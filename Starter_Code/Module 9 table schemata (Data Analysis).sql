...
SELECT employees.first_name, employees.last_name, employees.hired_date
FROM employees
WHERE hired_date >= '1986-01-01' and hired_date <'1987-01-01'
...
SELECT dept_emp.dept_no, employees.emp_no, employees.first_name, 
